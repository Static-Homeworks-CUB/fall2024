...
export class LiveVariables extends DataflowDetector {
    ...
    private performCopyPropagationAnalysis(
        ...
        const copyPropagationInfoMap = new Map<BasicBlockIdx, CopyPropagationInfo>();
         ...
         *     m  m  m 
         * 
         * gen = new defined vars (and not immediately overwritten)
        ...
        cfg.nodes.forEach((bb) => {
            ...
            const duplicatedDefinitionsSet = new Set(definedVariables.filter(def => def! in definedVariablesSet));
            copyPropagationInfoMap.set(bb.idx, {
                gen: setMinus(definedVariablesSet, duplicatedDefinitionsSet),
